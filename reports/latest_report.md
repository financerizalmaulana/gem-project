# GEM AI Analyst Report — 2026-08-26
...
- **Confidence:** 60.9/100
- **Full probability distribution:** Growth Risk-On 38.85%, Disinflation Normal 27.93%, Inflation Shock 24.36%, Crisis 8.86%
...
## 5. Active Warnings
- **[HIGH]** master_dataset.parquet's latest row is 2026-06-30 (57 days old). Every other check below is computed from this same stale data — the data ingestion pipeline (data/fetch_macro_data.py) may be failing silently.
