# GEM AI Analyst Report — 2026-08-20
...
- **Confidence:** 59.9/100
- **Full probability distribution:** Growth Risk-On 38.16%, Disinflation Normal 28.23%, Inflation Shock 24.73%, Crisis 8.88%
...
## 5. Active Warnings
- **[HIGH]** master_dataset.parquet's latest row is 2026-06-30 (51 days old). Every other check below is computed from this same stale data — the data ingestion pipeline (data/fetch_macro_data.py) may be failing silently.
