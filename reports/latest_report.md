# GEM AI Analyst Report — 2026-08-25
...
- **Confidence:** 59.4/100
- **Full probability distribution:** Growth Risk-On 37.69%, Disinflation Normal 28.32%, Inflation Shock 24.94%, Crisis 9.05%
...
## 5. Active Warnings
- **[HIGH]** master_dataset.parquet's latest row is 2026-06-30 (56 days old). Every other check below is computed from this same stale data — the data ingestion pipeline (data/fetch_macro_data.py) may be failing silently.
