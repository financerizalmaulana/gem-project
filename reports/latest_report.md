# GEM AI Analyst Report — 2026-09-17
...
- **Confidence:** 63.5/100
- **Full probability distribution:** Growth Risk-On 40.16%, Inflation Shock 26.64%, Disinflation Normal 24.13%, Crisis 9.07%
...
## 5. Active Warnings
- **[HIGH]** master_dataset.parquet's latest row is 2026-07-31 (48 days old). Every other check below is computed from this same stale data — the data ingestion pipeline (data/fetch_macro_data.py) may be failing silently.
