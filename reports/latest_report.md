# GEM AI Analyst Report — 2026-08-19
...
- **Confidence:** 58.9/100
- **Full probability distribution:** Growth Risk-On 37.45%, Disinflation Normal 28.55%, Inflation Shock 25.02%, Crisis 8.98%
...
## 5. Active Warnings
- **[HIGH]** master_dataset.parquet's latest row is 2026-06-30 (50 days old). Every other check below is computed from this same stale data — the data ingestion pipeline (data/fetch_macro_data.py) may be failing silently.
