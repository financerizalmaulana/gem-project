# GEM AI Analyst Report — 2026-09-21
...
- **Confidence:** 62.8/100
- **Full probability distribution:** Growth Risk-On 39.66%, Inflation Shock 26.81%, Disinflation Normal 24.55%, Crisis 8.99%
...
## 5. Active Warnings
- **[HIGH]** master_dataset.parquet's latest row is 2026-07-31 (52 days old). Every other check below is computed from this same stale data — the data ingestion pipeline (data/fetch_macro_data.py) may be failing silently.
